# 🐟 MiroFish — XAUUSD Trading Agent

MiroFish is a fully automated, algorithmic trading agent built exclusively for trading **Gold (XAUUSD)** on MetaTrader 5 (MT5). It is designed to act like a disciplined institutional trader, combining technical analysis, dynamic risk management, and live news monitoring.
...
2. **Configure MT5:**
   ...
   * Open MetaEditor, copy the code from `trading/MiroFishEA.mq5`, compile it, and attach it to an **XAUUSD** chart.
...
## 🔐 Risk Warning
*Trading foreign exchange and commodities on margin carries a high level of risk. This software is provided for educational and experimental purposes. Always use a demo account before risking real capital.*
